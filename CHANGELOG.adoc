...
- [releng] https://github.com/eclipse-sirius/sirius-web/issues/6400[#6400] [releng] Switch to pepper-mm 2026.4.0 to introduce the concept of dependencyLink, which will be used to implement actual delays in dependencies
